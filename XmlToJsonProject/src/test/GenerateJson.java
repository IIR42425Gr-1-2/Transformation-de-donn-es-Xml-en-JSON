/* GenerateJson.java */
/* Generated By:JavaCC: Do not edit this line. GenerateJson.java */
package test;

import java.io.*;
import java.util.*;

public class GenerateJson implements GenerateJsonConstants {
...
{if ("" != null) return nested.isEmpty() ? null : nested;}
  ...
  static public GenerateJsonTokenManager token_source;
  ...
  public GenerateJson(java.io.InputStream stream) {
	  this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public GenerateJson(java.io.InputStream stream, String encoding) {
	 ...
	 token_source = new GenerateJsonTokenManager(jj_input_stream);
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Constructor. */
  public GenerateJson(java.io.Reader stream) {
	 if (jj_initialized_once) {
	   System.out.println("ERROR: Second call to constructor of static parser. ");
	   System.out.println("	   You must either use ReInit() or set the JavaCC option STATIC to false");
	   System.out.println("	   during parser generation.");
 ...
 token_source = new GenerateJsonTokenManager(jj_input_stream);
  ...
  public GenerateJson(GenerateJsonTokenManager tm) {
	 if (jj_initialized_once) {
	   System.out.println("ERROR: Second call to constructor of static parser. ");
	   System.out.println("	   You must either use ReInit() or set the JavaCC option STATIC to false");
	   System.out.println("	   during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(GenerateJsonTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
